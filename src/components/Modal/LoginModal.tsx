...
export function LoginModal({ isOpen, onOpenChange }: LoginModalProps) {
  ...
  return (
    <Modal
      ...
      className="w-[calc(100%-32px)] max-w-[440px] rounded-[24px] border-none bg-white p-24 shadow-2xl sm:p-40"
    >
      <div className="flex flex-col items-center space-y-16 sm:space-y-24">
        ...
        <h2 className="text-center text-[18px] leading-relaxed font-medium text-[#000000]">
